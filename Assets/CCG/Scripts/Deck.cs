...
public class Deck : NetworkBehaviour
{
    ...
    //عدد داكس اي عدد انواع البطاقات  
    ...
    {
        //الوصول الى مكون يد اللعب من اجل اضافة البطاقة الى اليد
        PlayerHand playerHand = Player.gameManager.playerHand;
        for (int i = 0; i < amount; ++i)//مدام i اصغر من من عدد البطاقات المدخلة في الدالة قم بائظافة البطاقات
        {
            int index = i;
            playerHand.AddCard(index);//قم باضافة البطاقة الى اليد 
        }
